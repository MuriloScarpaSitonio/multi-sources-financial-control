    ...
    const onSubmit = data => {
        ...
        api.login(data)
            .then(response => {
                ...
                setAlertInfos({ message: 'Sucesso! Redirecionando...', severity: 'success' });
                props.history.push("/expenses")
            })
            .catch(error => {
                setAlertInfos({ message: error.response.data.detail, severity: 'error' });
        ...
        <Container component="main" maxWidth="xs">
            <div className={classes.paper}>
                ...
                <form className={classes.form}>
                    ...
                    >
                        {isLoaded ? "Login" : <CircularProgress size={24} style={{ color: "white" }} />}
                    </Button>
                    <Grid container>
                        <Grid item xs>
                        ...
                        <Grid item>
                            <Link href="#" variant="body2">Ainda não tem conta? Entre!</Link>
                        </Grid>
                    </Grid>
                    <FormFeedback
                        open={showAlert}
