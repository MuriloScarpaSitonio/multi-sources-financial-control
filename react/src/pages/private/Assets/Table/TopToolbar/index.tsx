...
import ShowHideColumnsMenuItem from "./ShowHideColumnsMenuItem";
import {
  SimulateTransactionMenuItem,
  SimulateTransactionDrawer,
} from "./SimulateTransactionMenuItem";
import ToggleDensityMenuItem from "./ToggleDensityMenuItem";
import ToggleFullScreenMenuItem from "./ToggleFullScreenMenuItem";
import { Filters } from "../types";
import NewTransactionDrawer from "./NewTransactionDrawer";
import NewIncomeDrawer from "./NewIncomeDrawer";

const TopToolBarExtraActionsMenu = ({ table }: { table: DataTable<Asset> }) => {
